			...
			<Popover className=" relative ">
				{({ open }) => (
					<>
						...
						>
							<Popover.Panel className=" absolute z-10 mt-3 w-96 max-w-sm -left-44 transform px-4 sm:px-0">
								<div className=" flex items-center gap-4 rounded-lg shadow-lg bg-white p-4">
									<div className=" w-16 h-16 flex bg-blue-600 rounded-full text-white items-center justify-center text-2xl ">
										<span>{getInitials(user?.name)}</span>
									</div>
