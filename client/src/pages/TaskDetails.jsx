...
const TaskDetails = () => {
	...
	return (
		<div className=" w-full flex flex-col gap-3 md-4 overflow-y-hidden ">
								...
								<div className=" w-full grid grid-cols-2 gap-4 ">
									{task?.assets?.map((el, index) => (
										<img
											...
											src={el}
											alt={task?.title}
											className=" w-full rounded h-28 md:h-26 2xl:h-52 cursor-pointer transition-all duration-700 hover:scale-125 hover:z-50 "
										/>
									))}
								</div>
							</div>
...
const Activities = ({ activity, id, refetch }) => {
	...
	return (
		<div className=" w-full flex gap-10 2xl:gap-20 min-h-screen px-10 py-8 bg-white shadow rounded-md justify-between overflow-x-auto ">
			{/* LEFT  */}
			...
			<div className=" w-full md:h-1/3 ">
				...
				<div className=" w-full flex flex-wrap gap-5 ">
					...
					<textarea
						...
						placeholder=" Type ....... "
						className=" bg-white w-full mt-10 border border-gray-300 outline-none p-4 rounded-md focus:right-2 ring-blue-500 "
					></textarea>
					{isLoading ? (
						<Loading />
					) : (
